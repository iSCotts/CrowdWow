...
<div class="hdr_btm_btm"><div class="hdr_btm_btm_lt"><a href="#">Quirky.com</a> &raquo; <a href="#">Shop</a></div>
<div class="hdr_btm_btm_md">
<a href="#">What's New</a>   <a href="#">Shipping Now </a>  <a href="#">Bed &amp; Bath </a>  <a href="#">Electronics &amp; Accessories</a>   <a href="#">Organization</a>   <a href="#">Kitchen</a>   <a href="#">Housewares</a>   <a href="#">Other</a><br />
</div>
...
<?php include("template/category_menu.php"); ?>
  ...
  great Quirky product
</p>
<p class="cntntnt">Help us choose the next great Quirky product</p>
...
<?php include("template/connect_us.php"); ?>
  ...
  <div class="bod_lt_rw4_mid"><img src="images/video.jpg" width="209" height="176" style="padding:9px 0 9px 7px" /></div><div class="bod_lt_rw4_btm"></div>
  </div></div><div class="bod_rt"><div class="bod_rt_top"><div class="bod_rt_top_top">Our products come from people just like you. <span class="bl">Come influence us!</span></div>
 ...
 <div class="bod_rt_top_btm_rt_prod_lt"><span class="infl"><a href="influnce.php">Influence Us</a></span></div>
  ...
  <div class="bod_rt_top_btm_rt"><span class="seeall"><a href="#">See all Products »</a></span><br />
    <br />
    <br />
    <br />
    <br />
...
genius idea to
<span class="qrky">Quirky</span></div>
