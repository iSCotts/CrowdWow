...
if($m=='pos')
{
$sql="SELECT * FROM colors WHERE cl_id = '".$q."'";
...
$uid=$row['u_id'];
 ...
 $vote=$vote+1;
 $update="update colors set u_id='".$uid.",".$u_id."',vote='$vote' where cl_id ='$q'";
mysql_query($update);
...
$sql1="SELECT * FROM colors WHERE cl_id = '".$q."'";
...
$user_id = substr($d,0,-1);
 ...
 $update2="update colors set u_id='$user_id',vote='$vote_idea1' where cl_id ='$q'";
mysql_query($update2);
?>
