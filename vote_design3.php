...
<a  style="background-color:#666666" class="button icon bright" onClick="hiddenHint3(<?php echo $s_id ?>,<?php echo $s_id; ?>)" >
...
while($row = mysql_fetch_array($result1))
 ...
 $update2="update themes set vote3='$vote_idea13' where t_id ='$q'";
mysql_query($update2);
?>
