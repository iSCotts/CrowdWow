...
if(isset($_POST['submit']))
{
 ...
 //$category=$_POST['shopradio'];
  ...
  $sql="insert into color_comment(cmmnt,cl_id,u_id) VALUES ('$cmt','$cid','$uid')";
...
<a href='evaluation.php' class='breadcrumb-link'>Product CMF</a>
				&nbsp;/&nbsp;
...
<p>
<?php
$sql1="select desc_idea from submit_idia where sub_id='$s_id'";
...
<?php
 ...
 $sql121="select * from colors where cl_id='$cid'";
...
?>
<font size=3 color=blue>(<?php echo $vote; ?>)</font>  Total Votes
</a>
...
<?php
$query="select * from colors where cl_id='$cid'";
...
<?php 
echo "<table>";
@$query3=mysql_query("select color_comment.cmmnt,color_comment.cl_id,user.u_firstname,user.u_lastname,user.u_id from color_comment inner join user on color_comment.u_id=user.u_id where color_comment.cl_id='$cid'");
