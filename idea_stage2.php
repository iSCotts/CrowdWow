...
window.location.href="idea_stage3.php?sid=<?php echo $sub_id; ?>";
</script>
<?php
}
...
?>
<script type="text/javascript">
window.location.href="idea_stage01.php?sid=<?php echo $sub_id; ?>";
</script>
<?php 
}
?>
...
<a href='invent.php' class='breadcrumb-link'>Invent</a>
			&nbsp;/&nbsp;
<span class='breadcrumb-current'>Idea stage 2</span>
</p>
...
<?php 
 $s="select * from submit_idia where sub_id='$sub_id'";
$q=mysql_query($s);
