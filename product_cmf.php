...
<a href='/projects' class='breadcrumb-link'>Influence</a> 
				&nbsp;/&nbsp;
<span class='breadcrumb-current'>Product CMF</span> 
</p> 
</div> 
</div> 
...
$q6=mysql_query("select days from duration where p_id='$id' and spent='branding'");
...
<div class="hd"> 
<h2>CMF</h2> 
<p><p>We’re almost at the end of the product development round for the multi-outlet extension cord, but before we launch, we need your help choosing some colors.</p> 
<p>In this project, we want you to vote on the final colors, materials, and finishes for this product.</p>
<p>Vote for the versions you like the best, and make sure you leave comments and suggestions as we might end up with a version that deviates from one or more of these concepts.</p>
...
<?php 
$id1=$_GET['i_id2'];
$s="select sum(vote) as vo from colors where p_id='$id1'";
$q=mysql_query($s);
...
<li class=""> 
<a href="product_res_result.php?i_id3=<?php echo $_GET['i_id2']; ?>"><span class="step completed">Product Research</span></a> 
</li> 
</ol> 
</li> 
<li class="timeline-component"> 
...
<ol class="timeline-component-steps"> 
<li class=""> 
<a href="concept_phase_result.php?i_id3=<?php echo $_GET['i_id2']; ?>"><span class="step completed">Concept Phase</span></a> 
</li> 
</ol> 
</li> 
<li class="timeline-component"> 
...
<ol class="timeline-component-steps"> 
<li class="expanded"> 
<a href="#"><span class="step">Product CMF</span></a> 
<span>Time Left: <br/>
...
<cite>               
						...
						by:<a href="idea.php?i_id=<?php echo $sid; ?>">Design Staff</a></cite></div>
</div>
<div class="ft">

<a class="n-comments" href="idea2.php?cid=<?php echo $row['cl_id']; ?>"><img src="images/icon_small_comments1.png" />&nbsp;&nbsp;Comments

<?php 
 $cid=$row['cl_id'];
 @$query2=mysql_query("select color_comment.cmmnt,color_comment.cl_id,user.u_id,user.u_id from color_comment inner join user on color_comment.u_id=user.u_id where color_comment.cl_id='$cid'");
...
<a class="rate-this" href="idea.php?cid=<?php echo $row['cl_id']; ?>">Total Votes <font size=3 color=blue>(<?php echo $row['vote']; ?>)</font></a> 
...
<div id="<?php echo  $cl_id; ?>">
<?php
$query11="select u_id from colors where p_id='$id1' and cl_id='$cl_id'";
...
{
?>
<a  style="background-color:#666666" class="button icon bright" onclick="hiddenHint(<?php echo $cl_id; ?>,<?php echo $cl_id; ?>)" >
<span class="text" style="width:182px;">Take your Vote</span>
<span class="check"></span></a>
<?php } } else { ?>
<a  class="button icon bright" onclick="showHint(<?php echo  $cl_id; ?>,<?php echo  $cl_id; ?>)" >
