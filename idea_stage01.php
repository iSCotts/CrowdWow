...
$sql="update submit_idia set u_id='$id',project_type='U',desc_idea='$didea',category='$category',desc_problem='$d_prob',desc_solution='$d_solut',invest='$bal',attach_files='$attechfile' where sub_id='$s_id'";
...
<textarea cols="40" id="idea_problem" name="idea_problem" rows="20"><?php echo $r2['desc_problem']; ?></textarea>
...
<input type="text" name="bal" id="bal"  value="<?php echo $r2['invest']; ?>"/>
</div></div>
