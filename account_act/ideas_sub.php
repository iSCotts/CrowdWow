...
<table width='930' cellspacing="0" bordercolor="#cccccc" border="2">
<?php 
$sq="select * from submit_idia inner join payment on submit_idia.sub_id=payment.sub_id where submit_idia.u_id='$userid' and submit_idia.sub_status='1' limit 10";
$go=mysql_query($sq);
$r=mysql_fetch_array($go);
$nr=mysql_num_rows($go);
?>
<tr>
<th class='alt' width="400" height="50"><p><span class='left'>Your Submissions</span> <span class=''>(<?php echo $nr; ?>)</span></p></th>
