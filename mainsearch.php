...
<div class="bod">
  <div class="bod_rt" style="margin-bottom:300px;">
<div style="width:500px; height:auto; padding:70px; padding-top:100px;">	
...
if($num>0)
{
    ...
    {?>
	   ...
	   <?php echo "<font size=3 >quirky is a social product development company. Your product ideas come in, our 
community works on them, we sell your product worldwide"; ?>
	   <br /><br />
          <?php echo "http://perflance.com/demo/quirky_new/".$row['url']; ?>
	   <?php $noresult=1; ?>
	   <br />
	   <hr/>
	   <?php
