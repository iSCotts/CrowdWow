...
session_start();
 ...
 $a="select add_to_cart from user where u_email='$email'";
 $b=mysql_query($a);
...
$sql="insert into product_payment(u_id,coupon_code,credit_card,card_number,ccv,expiration_date,credit_year, first_name, last_name, address_a, address_b, city,state, country,zip_code,phone_no,payment_cart ) VALUES ('$id','$co_cr','$cr_ty','$cr_no','$cccv','$ex_mont','$ex_year','$fname','$lname','$add_a','$add_b','$city','$state','$coun','$zip','$ph_no','$cart')";

 $query=mysql_query($sql);

?>
<script type="text/javascript">
window.location.href="idea_stage4.php?sid=<?php echo $id; ?>";
</script>
<?php
}
?>
...
<strong class="right"></strong><div id="payment-box" class="box mSmaller">
<h3>Payment</h3>
...
<div class="pay-item mSmaller">
<p class="item-title" style="margin-bottom:20px;"><b><u> Enter Credit Card Information</u></b></p>
...
<p class="item-title"><b><u> Enter a Billing Address</u></b></p>
