...
<a title="product Research">product upkeep</a>
<p class="countdown last left" rel="9966"></p> 
<a class="button small bright right" href="product_eval.php?i_id=<?php echo $row6['sub_id'];?>"><font color="#FFFFFF">Influence It</font></a>
<?php
$id=$row6['sub_id'];
 $sql="SELECT * FROM submit_idia where sub_id='$id'"; 
...
<script language="JavaScript" src="js/countdown2.js"></script>
...
?>
<span>research</span>
<a title="product Research">product Research</a>
<p class="countdown last left" rel="9966"></p> 
<a class="button small bright right" href="product_concept.php?i1_id=<?php echo $row6['sub_id'];?>"><font color="#FFFFFF">Influence It</font></a>

<?php
}

else if($vote>20 && $vote<30)
{
?>
<span>product design</span>
<a title="product Research">concept phase</a>
<p class="countdown last left" rel="9966"></p> 
<a class="button small bright right" href=""><font color="#FFFFFF">Influence It</font></a>
