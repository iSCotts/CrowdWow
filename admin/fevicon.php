...
$sql="update logo set fevicon='".$_FILES["file"]["name"]."'";
 $query2=mysql_query($sql);
 ?>
 <script type="text/javascript">
window.location.href="fevicon.php?dm=msg";
</script>
<?php
 }
 }
...
<section id="main" class="column">
	...
	<?php echo "successfully fevicon change"; }?>
	</h4>
	
	
		<article class="module width_3_quarter">
		<header>
	<h3 class="tabs_involved">Fevicon Setting</h3>
...
<?php 
		...
		{?>	
<img src="uploadimage/<?php echo $row['fevicon']; ?>" style="width:50px; height:50px;">	
			<?php
			}
			?>
</td></tr>
