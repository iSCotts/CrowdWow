...
if (isset($_POST['submit'])) 
{
 $detail=$_POST['detail'];
 $title=$_POST['title'];
 $v="INSERT INTO `contact_us` (`cu_title`,`contact`) VALUES ('$title','$detail')";
 mysql_query($v);

?>
 <script type="text/javascript">
window.location.href="contactus.php?dm=msg";
</script>
 <?php
 }
 ?>
...
<section id="main" class="column">
	...
	<?php echo "successfully added contact us"; }?>
	</h4>
	
		<article class="module width_3_quarter">
		<header>
	<h3 class="tabs_involved">Add Contact Us</h3>
...
<tr>
<td height="30" width="50">Contact Us</td>
