...
if (isset($_POST['submit'])) 
{
 ...
 $v="INSERT INTO `design` (`p_id`,`d_name`,`design`) VALUES ('$p_id','$name','$image')";
 mysql_query($v);
 ?>
...
function vali()
{
	...
	{
		document.getElementById('ptitle').innerHTML='Please Enter the first design';
		return false
	}
	else
	{
...
<section id="main" class="column">
	...
	<?php echo "successfully added a design"; }?>
	</h4>
		<article class="module width_3_quarter">
		<header>
	<h3 class="tabs_involved">Add Designes</h3>
