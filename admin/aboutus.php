...
if (isset($_POST['submit'])) 
{
 $detail=$_POST['detail'];
 $title=$_POST['title'];
 $v="INSERT INTO `about_us` (`au_title`,`about`) VALUES ('$title','$detail')";
 mysql_query($v);

?>
 <script type="text/javascript">
window.location.href="aboutus.php?dm=msg";
</script>
 <?php
 }
 ?>
...
<section id="main" class="column">
	...
	<?php echo "successfully added about us"; }?>
	</h4>
	
		<article class="module width_3_quarter">
		<header>
	<h3 class="tabs_involved">Add About Us</h3>
...
<tr>
<td height="30" width="50">About Us</td>
