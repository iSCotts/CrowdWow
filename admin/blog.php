...
$sql1=mysql_query("select p_id from article where name='$name'");
 while($row1=mysql_fetch_array($sql1))
 { $pid=$row1['p_id']; }
 $url="blog_comment.php?co_id=$pid";
$qq= "update article set url='$url' where name='$name'";
 $sql2=mysql_query($qq);
 ?>
...
<td><input type="text" name="name" style="width:340px;" /> &nbsp;<span id="namef" style="color:#FF0000"/></td></tr>

<tr>

<td height="30">Title</td>
<td><input type="text" name="title"  style="width:340px;" /> &nbsp;<span id="namel" style="color:#FF0000"/></td></tr>
<tr>
