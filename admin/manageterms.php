...
include("include/header.php");
 ...
 {
$did=$_GET['did'];
mysql_query("DELETE FROM t_and_c WHERE au_id='$did'");
?>
<script type="text/javascript">
window.location.href="manageterms.php?dm=msg";
</script>
<?php
}
...
{
$sid=$_GET['sid'];
 $sql2="update t_and_c set tc_status='1' where tc_id='$sid'";

$query2=mysql_query($sql2);

$sql2="update t_and_c set tc_status='0' where tc_id!='$sid'";
...
?>
<script type="text/javascript">
window.location.href="manageterms.php?sm=msg";
</script>
<?php
}
?>
...
//alert(did);
	...
	if (answer==true)
	{
	window.location.href = "manageterms.php?did="+did;
	return true;
	}
	else
	{
...
if (r==true)
  {
   window.location.href='manageterms.php?sid='+id+'&mode='+mode;
  }
else
  {
   return false;			
...
{
var googlewin=dhtmlwindow.open("googlebox", "iframe", "editterms.php?aid="+id, "Edit And Details", "width=400px,height=400px,resize=1,scrolling=1,center=1")
...
<section id="main" class="column">
	...
	<?php echo "successfully status change"; ?>
		...
		<header>
	<h3 class="tabs_involved">Manage T & C</h3>
...
{
$result = mysql_query("select * from t_and_c ");
  ...
  <td><?php echo $row['tc_title'] ;?></td>
	 ...
	 {
	 ?>
	  <a onClick="changesta(<?php echo $row['tc_id']; ?>, 'deact')" ><img src="images/check.png" /></a>
	  <?php
	  }
	  else
	  {
	  ?>
	  <a onClick="changesta(<?php echo $row['tc_id']; ?>, 'act')"><img src="images/no.png" /></a>
	  <?php }?></td>
	 <td class="cursor"> <a href="editterms.php?aid=<?php echo $row['tc_id']; ?>"><img src="images/edit.png"   /></a></td>
	<td class="cursor"><a  onClick="deleteid(<?php echo $row['tc_id']; ?>)"><img src="images/delete.png"  /></a></td>
			  </tr> <?php $i++; } }?>
