...
if ($_FILES["file"]["size"] < 20000000)
 ...
 $id=$_SESSION['u_id'];
 $sql="insert into submit_idia (u_id,project_type,desc_idea,category,desc_problem,desc_solution,attach_files,invest ) VALUES ('$id','A','$didea','$category','$d_prob','$d_solut','$attechfile','5000')";
...
<textarea cols="40" id="
idea_problem" name="idea_problem" rows="20"></textarea>
...
<p class="item-title">Describe Your Product Key Features</p>
...
<?php } else { ?>
<input type="submit" name="steg1"  value='Continue' />
<?php } ?>
