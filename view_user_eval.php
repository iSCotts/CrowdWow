...
<span>Time Left: <span class="countdown" rel="-273895"></span></span> 
</li> 
</ol> 
</li> 
...
<div class="left x5"> 
<?php 
$sql="select distinct submit_idia.desc_idea,submit_idia.sub_id,submit_idia.attach_files,submit_idia.u_id from submit_idia where project_type='U'";
...
{
?>
                by: <a href="view_profile1.php?userid1=<?php echo $row['u_id']; ?>"><?php echo $row1['first_name']; ?></a>     
