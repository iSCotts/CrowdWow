...
<a href='influnce.php' class='breadcrumb-link'>Influence</a> 
				&nbsp;/&nbsp;
<span class='breadcrumb-current'>Branding</span> 
</p> 
</div> 
</div> 
...
<p class="item-title"><b>Please suggest the name?</b></p>
...
?>
<h3 style="width:248px;"><a href="idea4.php?d_id=<?php echo $sid; ?>&id=<?php echo $pid; ?>" style="text-decoration:none;"><img src="images/icon_small_comments1.png"/>Comments(<?php if($nr1==0){echo "0";}else { echo $nr1; }  ?>)&nbsp;&nbsp;</a>Total Votes <font size=3 color=blue>(<?php echo $row['pro_vote']; ?>)</font></h3>
...
<div id="<?php echo  $pid; ?>">
<?php
$query11="select u_id from pro_naming where sub_id='$id1' and pro_id='$pid'";
