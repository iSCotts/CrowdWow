...
if(isset($_POST['submit']))
{
 ...
 //$category=$_POST['shopradio'];
  ...
  $sql="insert into design_comment(dcmmnt,d_id,u_id) VALUES ('$cmt','$did','$uid')";
...
<a href='concept_phase.php?i_id3=<?php echo $i_id3; ?>'> Concept Phase</a>
				&nbsp;/&nbsp;
...
<?php
 ...
 $sql121="select * from design where d_id='$did'";
...
<?php
$query="select * from design where d_id='$did'";
...
?>
<img src="admin/uploadimage/<?php echo $design; ?>" height="350" width="450">
...
<?php 
echo "<table>";
@$query3=mysql_query("select design_comment.dcmmnt,design_comment.d_id,user.u_firstname,user.u_lastname,user.u_id from design_comment inner join user on design_comment.u_id=user.u_id where design_comment.d_id='$did'");
